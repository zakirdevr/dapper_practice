...
namespace DapperDemo.Repository
{
    public class EmployeeRepository : IEmployeeRepository
    {
        ...
        {
            this.db = new SqlConnection(configuration.
        ...
        {
            var sql = "UPDATE Employees SET Name = @Name, Title = @Title, " +
                "Email = @Email, Phone = @Phone, CompanyId = @CompanyId WHERE EmployeeId = @EmployeeId";
